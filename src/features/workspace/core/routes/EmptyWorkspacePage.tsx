...
const EmptyWorkspacePage: React.FC = () => {
    ...
    const handleCreateWorkspace = async () => {
        ...
        try {
            const workspace = await workspaceContext.createWorkspace(createForm);
    ...
    const handleJoinWorkspace = async () => {
        ...
        try {
            ...
            if (type === 'url') {
                workspace = await workspaceContext.joinWorkspaceById(value, joinForm.password || undefined);
            } else {
                workspace = await workspaceContext.joinWorkspace({
                    inviteCode: value,
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-primary-light to-primary flex items-center justify-center p-4">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-shadow">
                        ...
                        <Button 
                            ...
                            className="w-full"
                            disabled={workspaceContext.loading}
                        >
                            워크스페이스 만들기
                        </Button>
                    </div>
            ...
            <Modal 
                ...
                footer={
                    <div className="flex justify-end space-x-2">
                        <Button variant="ghost" onClick={resetCreateModal} disabled={workspaceContext.loading}>
                            취소
                        </Button>
                        <Button onClick={handleCreateWorkspace} disabled={workspaceContext.loading}>
                            {workspaceContext.loading ? '생성 중...' : '워크스페이스 생성'}
                        </Button>
                    </div>
                }
            >
            ...
            <Modal 
                ...
                footer={
                    <div className="flex justify-end space-x-2">
                        <Button variant="ghost" onClick={resetJoinModal} disabled={workspaceContext.loading}>
                            취소
                        </Button>
                        <Button onClick={handleJoinWorkspace} disabled={workspaceContext.loading}>
                            {workspaceContext.loading ? '참가 중...' : '워크스페이스 참가'}
                        </Button>
                    </div>
                }
            >
