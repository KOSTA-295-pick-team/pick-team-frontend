...
export const TeamSpacePage: React.FC = () => {
    ...
    if (!workspaceId || !teamId) {
        return <div className="p-6 text-center">잘못된 접근입니다. 워크스페이스 또는 팀 ID가 없습니다.</div>;
    }
    ...
    switch(activeTab) {
        ...
        case 'calendar': 
            ...
            break;
        case 'kanban': 
            contentToRender = <TeamKanbanBoard teamProjectId={teamId} currentUser={currentUser} teamMembers={teamMembers} />; 
            break;
        default: 
